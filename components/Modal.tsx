...
const Modal = ({
  ...
  show: boolean;
  onClose: {
    // ( state: Awaited<{}>, payload: FormData ): Promise<{ isSubmitted: boolean; show?: boolean }>,
    (): void,
  }
}) => {
  ...
  const portal = usePortal(children, { rootId: "modalContainer", cleanup: onClose })
  // const [show, setShow] = useState<boolean>(_show ?? false);
...
// (
//       <div className="min-h-128 bg-white fixed inset-0 overflow-y-auto h-screen w-screen flex items-center justify-center backdrop-brightness-40 z-[10000]">
