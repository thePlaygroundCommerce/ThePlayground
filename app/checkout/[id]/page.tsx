...
const MobileCheckoutConfirmation = ({
  ...
  const recipient =
    processedCart.fulfillments?.find(
  ...
  const customerDetail = {
    ...
    zipAndCountry:
      ...
      `${recipientAddress.postalCode} ${recipientAddress.country}`,
  };
  ...
  const paymentDetails = {
    ...
    address:
      paymentAddress?.addressLine1 &&
      paymentAddress?.addressLine2 &&
      `${paymentAddress?.addressLine1} ${paymentAddress?.addressLine2}`,
    zipAndCountry:
      paymentAddress?.postalCode &&
      paymentAddress?.country &&
      `${paymentAddress.postalCode} ${paymentAddress.country}`,
  };
    ...
    <>
      ...
      <div className="my-12 md:flex gap-8">
        <div className="basis-1/4">
          ...
          {Object.values(customerDetail).map((detail) => (
        ...
        <div>
          ...
          {Object.values(paymentDetails).map((detail) => (
            <p key={detail}>{detail}</p>
          ))}
        </div>
      </div>
