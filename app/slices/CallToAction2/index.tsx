 ...
 */
export type CallToAction2Props =
  SliceComponentProps<Content.CallToAction2Slice>;

/**
 * Component for "CallToAction2" Slices.
 */
const CallToAction2 = ({ slice }: CallToAction2Props): JSX.Element => {
